...
<%--    <link href="http://fontawesome.io/font-awesome.min.css" rel="stylesheet">--%>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="line dk"></li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/index_v1.jsp">
                ...
                <li class="line dk"></li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/common/bingqingmiaoshu">
                        <i class="fa fa fa-bar-chart-o"></i>
                        <!--                            <a class="J_menuItem" href="css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">CSS动画</span></a>-->
                        <span class="nav-label" >病情描述</span>
                        <!--                            <span class="fa arrow"></span>-->
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/common/yucekenengjibing"><i class="fa fa-envelope"></i> <span class="nav-label">病情分析与判断 </span></a>
                </li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/bingliguifanhua.jsp"><i class="fa fa-edit"></i> <span class="nav-label">病情确诊</span></a>
                </li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/binglishujuku.jsp"><i class="fa fa-cutlery"></i> <span class="nav-label">病例数据库</span></a>
                </li>
                <li class="line dk"></li>
                <li>
                    <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">个人传染病</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<%=path%>/xintiaojiance.jsp">心跳详情</a>
                        </li>
                        <li><a class="J_menuItem" href="<%=path%>/tiwenjiance.jsp">体温详情</a>
                        </li>

                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-flask"></i> <span class="nav-label">群体传染病信息</span></a>

                </li>
                <li>
                    <a class="J_menuItem" href="<%=path%>/common/jujixingchuanranbing"><i class="fa fa-table"></i> <span class="nav-label">聚集性传染病及预测</span></a>
                </li>
                ...
                <!--                    </li>-->
                <li>
                    <a class="J_menuItem" href="<%=path%>/changjianjijiexingchuanranbing.jsp"><i class="fa fa-picture-o"></i> <span class="nav-label">常见季节性传染病</span></a>
                    <!--                        <ul class="nav nav-second-level">-->
                ...
                <li class="line dk"></li>
<%--                <li>--%>
<%--                    <a class="J_menuItem" href="<%=path%>/css_animation.jsp"><i class="fa fa-magic"></i> <span class="nav-label">遗传病</span></a>--%>
<%--                </li>--%>
<%--                <li>--%>
<%--                    <!--                        <span class="fa arrow"></span>-->--%>
<%--                    <!--                        这个是这个页面能够分出其他页面的标志-->--%>
<%--                    <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">遗传病</span></a>--%>
<%--                    <!--                        <ul class="nav nav-second-level">-->--%>
...
<%--                </li>--%>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="<%=path%>/index_v1.jsp?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
...
<%--        <div  id="chart" style="height:700px;width:600px;margin:0 auto">  </div>--%>
