...
<%--                    <h3 >系统根据您所描述病情，最后得出结论，您很有可能患了“高血压”这种疾病</h3>--%>
                </div>
                <br>
                <div align="center">
                    <button style="height:40px;width:200px"><a  href="<%=path%>/bingliguifanhua.jsp" style="color: black;margin:0 auto;font-size:16px">点击查看疾病具体信息</a></button>
                </div>
                <br>
                <br>
