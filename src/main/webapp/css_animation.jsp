            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="<%=path%>/css_animation.jsp#">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="<%=path%>/css_animation.jsp#">选项1</a>
                            </li>
                            <li><a href="<%=path%>/css_animation.jsp#">选项2</a>
                            </li>
                        </ul>
                        <a class="close-link">
                ...
                <div class="ibox-content text-center css-animation-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 animation-efect-links text-center">
                            ...
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounce">bounce</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="flash">flash</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="pulse">pulse</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="rubberBand">rubberBand</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="shake">shake</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="swing">swing</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="tada">tada</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="wobble">wobble</a>


                            <!--<h5 class="text-navy">Bouncing Entrances</h5>-->
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceIn">bounceIn</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceInDown">bounceInDown</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceInLeft">bounceInLeft</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceInRight">bounceInRight</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceInUp">bounceInUp</a>


                            <!--<h5 class="text-navy">Bouncing Exits</h5>-->
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceOut">bounceOut</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceOutDown">bounceOutDown</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceOutLeft">bounceOutLeft</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceOutRight">bounceOutRight</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="bounceOutUp">bounceOutUp</a>
                            <!--<h5 class="text-navy">Fading Entrances</h5>-->
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="fadeIn">fadeIn</a>
                            <a href="<%=path%>/css_animation.jsp#" class="btn btn-white animation_select" data-animation="fadeInDown">fadeInDown</a>
...
<!-- Rickshaw -->
<script src="<%=path%>/js/plugins/rickshaw/vendor/d3.v3.js"></script>
<script src="<%=path%>/js/plugins/rickshaw/rickshaw.min.js"></script>
